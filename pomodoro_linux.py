...
class NotificationWindow(tk.Toplevel):
    ...
    def _construir_ui(self, seg_extra, bonus_seg, base_seg):
        ...
        tk.Label(body, text="🎉", font=("Helvetica Neue", 22),
                 bg=COR_BG).pack()
        ...
        tk.Label(body, text=info, font=("Helvetica Neue", 9),
...
class PomodoroApp(tk.Tk):
    ...
    def _configurar_janela(self):
        ...
        try:
            ...
            img = PilImage.open(_resource("logo.png")).resize((64, 64), PilImage.LANCZOS)
    ...
    def _construir_ui(self):
        ...
        self._btn_gear = tk.Button(
            bar, text="⚙", font=("Helvetica Neue", 12),
        ...
        for chave, label in campos:
            ...
            entry = tk.Entry(row, textvariable=var, width=6,
                             font=("Helvetica Neue", 9), bg=COR_BORDER, fg=COR_FG,
